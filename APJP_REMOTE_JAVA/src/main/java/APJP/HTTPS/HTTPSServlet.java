...
public class HTTPSServlet extends HttpServlet {
	...
	public void init(ServletConfig servletConfig) throws ServletException
	{
		...
		{
			APJP_REMOTE_HTTPS_SERVER_RESPONSE_PROPERTY_KEY[i] = properties.getProperty("APJP_REMOTE_HTTPS_SERVER_RESPONSE_PROPERTY_" + (i + 1) + "_KEY", "");
			APJP_REMOTE_HTTPS_SERVER_RESPONSE_PROPERTY_VALUE[i] = properties.getProperty("APJP_REMOTE_HTTPS_SERVER_RESPONSE_PROPERTY_" + (i + 1) + "_VALUE", "");
		}
	}
